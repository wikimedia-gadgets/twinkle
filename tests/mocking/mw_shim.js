/**
 * Helper functions to fake mw object data for CLI testing of the Morebits library.
 *
 * Includes just what we care about:
 * log
 * Map
 * config (barebones, will need data set)
 * util (but plenty of excessive functions)
 *     - All of morebits just needs: escapeRegExp, getParamValue, getUrl, isIPv6Address, wikiScript
 *         - getParamValue (mb.w.page), wikiScript (mb.w.api), getUrl (batch, others)
...
/**
 * mw.log
 * We just need the `warn` method, but might as well mw.log = console.log
 * https://gerrit.wikimedia.org/r/plugins/gitiles/mediawiki/core/+/a27e2f17c22b98fd95e449396b26e4e7d77e299f/resources/src/startup/mediawiki.js#273
 */
mw.log = console && Function.prototype.bind.call(console.log, console);
mw.log.warn = console && console.warn ?
	Function.prototype.bind.call(console.warn, console) :
	function() {};

/**
 * mw.Map
 * Needed for various things, in particular mw.config
 * https://gerrit.wikimedia.org/r/plugins/gitiles/mediawiki/core/+/a27e2f17c22b98fd95e449396b26e4e7d77e299f/resources/src/startup/mediawiki.js#135
 */
mw.Map = function Map( global ) {
...
/** https://gerrit.wikimedia.org/r/plugins/gitiles/mediawiki/core/+/a27e2f17c22b98fd95e449396b26e4e7d77e299f/resources/src/startup/mediawiki.js#157 */
mw.Map.prototype = {
	constructor: mw.Map,
...
/**
 * mw.config
 * Initialize with empty mw.Map, we can just set the values that we want/need.
 * mw.config data set separately.
 * https://gerrit.wikimedia.org/r/plugins/gitiles/mediawiki/core/+/a27e2f17c22b98fd95e449396b26e4e7d77e299f/resources/src/startup/mediawiki.js#413
 */
mw.config = new mw.Map();

/**
 * mw.util
 * Some of these aren't fully required by Morebits or other files, but here
 * to facilitate ease of use.  Taken from:
 * https://gerrit.wikimedia.org/g/mediawiki/core/+/a27e2f17c22b98fd95e449396b26e4e7d77e299f/resources/src/mediawiki.util/util.js
 */

// config file for some options, possibly unnecessary
var config = {
	FragmentMode: ['html5'],
	LoadScript: 'load'
};
...
/**
 * mw.user.tokens
 * https://gerrit.wikimedia.org/r/plugins/gitiles/mediawiki/core/+/a27e2f17c22b98fd95e449396b26e4e7d77e299f/resources/src/mediawiki.base/mediawiki.base.js#733
 * Nonfunctional, needs https://gerrit.wikimedia.org/r/plugins/gitiles/mediawiki/core/+/a27e2f17c22b98fd95e449396b26e4e7d77e299f/resources/src/mediawiki.user.js
