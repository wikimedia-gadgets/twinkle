			...
			{ tag: 'Notability', description: 'subject may not meet the general notability guideline',
				subgroup: {
					...
					list: [
						...
						{ label: '{{notability|Companies}}: notability guidelines for companies', value: 'Companies' },
						...
						{ label: '{{notability|Organizations}}: notability guidelines for organizations', value: 'Organizations' },
