...
Twinkle.tag.article.tagList = {
	...
	'General content issues': {
		...
		'Verifiability and sources': [
			...
			{ tag: 'No signifigant coverage' , description: 'article contains no sources with signifigant coverage' },
			{ tag: 'No signifigant coverage (sports)', description: 'Sports bio that has no sources containing signifigant coverage' },
