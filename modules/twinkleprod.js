...
Twinkle.prod.callbacks = {
	main: function(pageobj) {
		...
		text = text.replace(/\{\{\s*(new unreviewed article|unreviewed|userspace draft|mtc|(copy |move )?to ?commons|move to wikimedia commons|copy to wikimedia commons)\s*(\|(?:\{\{[^{}]*\}\}|[^{}])*)?\}\}\s*/gi, "");
