...
Twinkle.batchundelete.callback = function twinklebatchundeleteCallback() {
	...
	Window.addFooterLink( "Trợ giúp Twinkle", "en:WP:TW/DOC#batchundelete" );
...
Twinkle.batchundelete.callback.evaluate = function( event ) {
	...
	Morebits.wiki.actionCompleted.postfix = 'đã phục hồi hàng loạt thành công';
	...
	batchOperation.run(function(pageName) {
		...
		var wikipedia_api = new Morebits.wiki.api( "Đang phục hồi trang " + pageName, query,
			batchOperation.workerSuccess, null, batchOperation.workerFailure );
		wikipedia_api.statelem.status("đang phục hồi…");
