...

{
	...
	preferences: [
		...
		// with a "firstarticle" notice if his talk page has not yet been created.
		{
			...
			helptip: "The welcome is issued only if the user is notified about the deletion, and only if their talk page does not already exist. The template used is {{<a href=\"" + Morebits.wikiGetlink("Template:Firstarticle") + "\">firstarticle</a>}}.",
			type: "set",
			setValues: Twinkle.config.commonSets.csdCriteria,
			setDisplayOrder: Twinkle.config.commonSets.csdCriteriaDisplayOrder
		},
...

{
	...
	preferences: [
		...
		// if true, blank the talk page when issuing an indef block notice (per [[WP:UW#Indefinitely blocked users]])
		{
			...
			helptip: "See <a href=\"" + Morebits.wikiGetlink("WP:UW#Indefinitely blocked users") + "\">WP:UW</a> for more information.",
			adminOnly: true,
			type: "boolean"
		}
	]
...
Twinkle.config.init = function twinkleconfigInit() {
	...
	if ((mw.config.get("wgPageName") === "Wikipedia:Twinkle/Preferences" ||
		...
		contentnotice.innerHTML = "<b>Before modifying your preferences here,</b> make sure you have removed any old <code>TwinkleConfig</code> and <code>FriendlyConfig</code> settings from your <a href=\"" + Morebits.wikiGetlink("Special:MyPage/skin.js") + "\" title=\"Special:MyPage/skin.js\">user JavaScript file</a>.";
		...
		if (mw.config.get("wgTitle") === mw.config.get("wgUserName") + "/twinkleoptions.js") {
			...
			link.setAttribute("href", Morebits.wikiGetlink("Wikipedia:Twinkle/Preferences") );
...
Twinkle.config.saveSuccess = function twinkleconfigSaveSuccess(pageobj) {
	...
	noticebox.innerHTML = "<p><b>Your Twinkle preferences have been saved.</b></p><p>To see the changes, you will need to <a href=\"" + Morebits.wikiGetlink("WP:BYPASS") + "\" title=\"WP:BYPASS\"><b>bypass your browser cache</b></a>.</p>";
