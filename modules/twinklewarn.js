...
Twinkle.warn.callback = function twinklewarnCallback() {
	...
	if (vanrevid) {
		...
		if (!Twinkle.getPrefill('noautowarn') && Twinkle.getPrefill('vanarticle')) { // Via Twinkle rollback link
			query = {
				action: 'query',
		...
		// Provided from a Twinkle rollback module-based revert, no API lookup necessary
		if (vantimestamp) {
