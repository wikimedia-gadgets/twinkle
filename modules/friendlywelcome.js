	...
	Twinkle.welcome.templates = {
		standard: {
			...
			'Problem user welcome templates': {
				...
				'welcome-suboptimal' : {
					description:'for someone whose initial efforts were clearly intended to be constructive, but were removed',
					linkedArticle: true,
					syntax: '{{subst:welcome-suboptimal|$ARTICLE$|$USERNAME$}} ~~~~'
				}
			}
		},
			...
			'Anonymous user welcome templates': {
				...
				'welcome-anon-delete': {
					...
					'welcome-anon-suboptimal': {
						description: 'for anonymous users whose initial efforts were clearly intended to be constructive, but were removed',
						linkedArticle: true,
						syntax: '{{subst:welcome-anon-suboptimal|$ARTICLE$|$USERNAME$}} ~~~~'
				}
			}
		},
