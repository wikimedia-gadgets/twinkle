			...
			list: [
				{
					...
					value: 'delmultiple',
					name: 'delmultiple',
					tooltip: "Khi được chọn, bạn có thể chọn nhiều tiêu chí để áp dụng vào trang. Ví dụ C9 và BV4 thường được sử dụng cùng lúc đối với một bài.",
					event: function( event ) {
...
Twinkle.speedy.customRationale = [
	{
		label: 'Lý do khác' + (Morebits.userIsInGroup('sysop') ? ' (lý do xóa khác)' : ' dùng bản mẫu {{db}}'),
		value: 'reason',
