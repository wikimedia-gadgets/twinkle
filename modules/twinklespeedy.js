...
Twinkle.speedy.getArticleList = function twinklespeedyGetArticleList(multiple) {
    ...
    if (!multiple) {
        ...
        result.push({
            ...
            value: 'animal',
            tooltip: 'Article about an animal that does not assert the importance or significance of its subject'
        });
    }
    result.push({
...
// Articles
    ...
    'animal': 'No explanation of the subject\'s significance (animal)',
